...
namespace Microsoft.Health.Fhir.Tests.Common
{
    public class MockModelInfoProviderBuilder
    {
        ...
        public static MockModelInfoProviderBuilder Create(FhirSpecification version)
        {
            ...
            IStructureDefinitionSummaryProvider structureDefinitionSummaryProvider = Substitute.For<IStructureDefinitionSummaryProvider>();
            structureDefinitionSummaryProvider.Provide(Arg.Any<string>()).Returns(Substitute.For<IStructureDefinitionSummary>());

            provider.StructureDefinitionSummaryProvider.Returns(structureDefinitionSummaryProvider);
